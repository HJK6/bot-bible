...
app.whenReady().then(async () => {
  ...
  // Restore previous slots after renderer is ready
  const savedSlots = loadSlotState();
  mainWindow.webContents.on('did-finish-load', () => {
    // Stagger slot restoration to avoid race conditions
    let delay = 300;
